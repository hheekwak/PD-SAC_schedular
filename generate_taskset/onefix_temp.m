...
% Designed N * sz_taskset different tasksets
% Hard real time tasksets
clc; close all; clear all;

sets = {};
N = 1000; % Number of tasksets of specific position of fixed task
...
ss = size(sets);
fileID = fopen('../data/chain_case5_1000.txt', 'w');
fileNum = fopen('../data/chain_case5_1000util.txt', 'w');
